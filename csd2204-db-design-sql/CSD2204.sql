...
CREATE TABLE providers (code VARCHAR(3) PRIMARY KEY, name varchar(100));

CREATE TABLE pieces (code INT PRIMARY KEY, name varchar(100));

CREATE TABLE provides (
	code INT AUTO_INCREMENT,
	piece INT ,
	provider VARCHAR(3),
	price DECIMAL(10,2) CHECK(price>10),
