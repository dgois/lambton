-- Tables for the exam
CREATE DATABASE IF NOT EXISTS ExamC0711561;
USE ExamC0711561;

-- mysql -u root -p ExamC0711561
...
CREATE TABLE Shipment (
  ...
  Date TEXT,
  Manager INTEGER NOT NULL REFERENCES Employee(EmployeeID),
  Planet INTEGER NOT NULL REFERENCES Planet(PlanetID)
);

CREATE TABLE Has_Clearance (
  Employee INTEGER NOT NULL REFERENCES Employee(EmployeeID),
  Planet INTEGER NOT NULL REFERENCES Planet(PlanetID),
...
CREATE TABLE Package (
  Shipment INTEGER NOT NULL REFERENCES Shipment(ShipmentID),
  PackageNumber INTEGER NOT NULL,
  Contents TEXT NOT NULL,
  Weight REAL NOT NULL,
  Sender INTEGER NOT NULL REFERENCES Client(AccountNumber),
  Recipient INTEGER NOT NULL REFERENCES Client(AccountNumber),
